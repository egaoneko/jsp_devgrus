...
public class ReplyFormHandler implements CommandHandler {
    ...
    public String process(HttpServletRequest request, HttpServletResponse response) throws Throwable {
        ...
        int parentCommentId = Integer.parseInt(request.getParameter("parentId"));
        ...
        try{
            ...
            Comment parent = commentDao.selectById(conn, parentCommentId);

            try {
                checkParent(parent, parentCommentId);
            } catch (Exception e){
            ...
            return "/view/comment/replyForm.jsp";
