...
<table>
  ...
  <tr>
    <td colspan="2">
      ...
      <a href="/board/replyForm.do?parentId=${article.id}&p=${param.p}">답변하기</a>
      <a href="/board/updateForm.do?articleId=${article.id}&p=${param.p}">수정하기</a>
      <a href="/board/deleteForm.do?articleId=${article.id}">삭제하기</a>
    </td>
  </tr>
</table>
